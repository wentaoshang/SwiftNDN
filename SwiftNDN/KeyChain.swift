...
public class KeyChain {
    ...
    public func sign(data: Data, onFinish: (Data) -> Void, onError: (String) -> Void) {
        ...
        if let signedPortion = data.getSignedPortion() {
            ...
            onError("KeyChain.sign: failed to extract signed portion of data")
        }
        return
    }
    ...
    public func verify(data: Data, onSuccess: () -> Void, onFailure: (String) -> Void) {
        if let signedPortion = data.getSignedPortion() {
            ...
            onFailure("KeyChain.verify: failed to extract signed portion of data")
        }
        return
    }
}